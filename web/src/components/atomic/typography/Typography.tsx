...
const Typography = ({ type, children, className }: TypographyProps) => {
    ...
    switch (type) {
        case "h1":
            return <h1 className={`${baseClasses} text-stone-950 text-5xl  lg:leading-[64px] lg:text-7xl `}>{children}</h1>
        case "h2":
            return <h2 className={`${baseClasses} text-5xl font-black text-stone-950 lg:text-6xl leading-[64px]`}>{children}</h2>
        case "h3":
            return <h3 className={`${baseClasses} lg:text-5xl`}>{children}</h3>
        case "h4":
            return <h4 className={`${baseClasses} lg:text-4xl`}>{children}</h4>
        case "h5":
            return <h5 className={`${baseClasses} lg:text-3xl`}>{children}</h5>
        case "h6":
            return <h6 className={`${baseClasses} lg:text-2xl`}>{children}</h6>
        case "p":
            return <p className={`${baseClasses} lg:text-xl`}>{children}</p>
        default:
