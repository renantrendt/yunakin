...
const Testimonial = () => {
    ...
    return (
        <div className='my-20 w-full'>
            ...
            <section className='grid grid-cols-1 lg:grid-cols-3 gap-x-6  justify-center'>
                {testimonials.map((testimonial, index) => (
                    <div key={index} className='card bg-base-100  h-full p-5 '>
                        <div className='card-body flex justify-center items-center shadow-lg'>
                            <p className='w-[316px] text-center mb-8'>{testimonial.content}</p>
