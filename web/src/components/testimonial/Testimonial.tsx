...
const Testimonial = () => {
    ...
    return (
        <div className='my-20 w-full text-black dark:text-white'>
            ...
            <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6 justify-center '>
                {testimonials.map((testimonial, index) => (
                    <div key={index} className='card dark:bg-gray-700 shadow border font-["Inter"] border-neutral-200 flex-col    h-full p-5 '>
                        <div className='card-body flex py-8   border-justify-center items-center '>
                            <p className='max-w-[316px] text-neutral-600 dark:text-white text-base text-center font-light'>{testimonial.content}</p>
