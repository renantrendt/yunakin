...
const Cta = () => {
    return (
        <div className="my-20 w-full flex-col justify-center items-center gap-20 inline-flex dark:text-white">
            ...
            <div className="flex flex-col md:flex-row justify-start items-start gap-6 dark:text-white  ">
                {reasons.map((reason) => (
