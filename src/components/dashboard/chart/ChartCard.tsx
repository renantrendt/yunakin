...
const ChartCard = ({ title, summary, children }: ChartCardProps) => {
    return (
        <div className='shadow-sm first:lg:col-span-2 bg-white  border border-grey-200 dark:border-profile-modal-border-dark p-6 rounded-2xl flex flex-col justify-stretch gap-6 dark:bg-profile-modal-background-dark'>
            <div>
